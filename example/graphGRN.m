...
GraphGRN::usage = "Display a graphic representation of the Gene Regulatory Network topology";

GraphGRNInteractionStrength::usage = "Display a graphic representation of the Gene Regulatory Network in which edge thickness represents interaction strength";
...
GraphGRN[mKVsMatrix_List]:=Block[{EdgeComponents,Edge2ColorMap,ArrowHeadMap},
...
GraphGRNInteractionStrength[mKVsMatrix_List]:=Block[{},
HapRegMotifs=Prepend[Partition[(#[[1]]-> #[[2]])&/@Tuples[{"A","B","C"},2],3],
{"\!\(\*SubscriptBox[\(M\), \(\!\(\*
StyleBox[\"A\",\nFontSize->0]\)\)]\)"->"A","\!\(\*SubscriptBox[\(M\), \(\!\(\*
StyleBox[\"B\",\nFontSize->0]\)\)]\)"->"B","\!\(\*SubscriptBox[\(M\), \(\!\(\*
