...
enlaces salientes a partir de una matriz de adyacencia en un grafo dirigido."

vertexDegrees[adjacencyMatrix_] := Total[ Abs[Sign[ adjacencyMatrix ]] ]

complexityIndex::usage="complexityIndex[ adjacencyMatrix ] calcula el índice de
complejidad de la red representada por una matriz de adyacencia."
