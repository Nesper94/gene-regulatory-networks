...
as well as Hedgehog and Wnt.
However, information processing by GRNs has proven to be a complex process, and
a major goal of developmental biology is to understand mechanistically how
positional information given by morphogens is translated in spatial
differentiation.\\
...
\paragraph*{S3 Fig.}
\begin{figure}[!h]
 \includegraphics[width=\textwidth]{figures/supplementary-figures/GRN_660_topol_33_spatio-temp_exp_profile}
