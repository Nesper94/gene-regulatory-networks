...
\newcommand{\hil}[1]{\hl{#1}} % Highlight changes
% \newcommand{\hil}[1]{#1} % Do nothing, clean version
...
proportional to the strength of the interaction. \hil{In this study we define
...
a matrix  $T = (t_{ij})$ with \hil{each row} corresponding to \hil{a}
different topology
