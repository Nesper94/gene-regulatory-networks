...
\cite{Turing1952} and posterior theoretical studies on morphogens led to the
french flag model \cite{Wolpert1969}, in which a gradient of concentration of
the morphogen induces differentiation in a one-dimensional field of cells.
...
\begin{figure}[!h]
%  \centering
 \includegraphics[width=\textwidth]{figures/metodos/fig_1}
    ...
    (D) Spatiotemporal expression profile of a GRN.
 \label{fig:model}
\end{figure}
...
\begin{figure}[!h]
 \includegraphics[width=\textwidth]{figures/results/distribution_most_abundant_topologies}
 \caption{\bf Distribution of abundances of network topologies.}
 Most frequent network topologies shown in the grid contain the I3-FFL network
 motif. Topologies are numbered in order of decreasing abundance. The number of
 GRNs belonging to each network topology is presented below topology number.
...
\begin{figure}[!h]
 \includegraphics[width=\textwidth]{figures/results/vertex_degree_dist-abundance_vs_node_degree}
...
\begin{figure}[!h]
 \includegraphics[width=\textwidth]{figures/results/abundance-robustness-complexity-index}
 ...
 calculated as the number of perturbations in which the fitness was greater or
...
\begin{figure}[!h]
 \includegraphics[width=\textwidth]{figures/results/clustering_of_grns_and_topologies}
