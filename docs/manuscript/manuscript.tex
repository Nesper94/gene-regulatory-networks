...
and final concentration were constant in all the fields (\nameref{S5_Fig}A).
...
in fields with 10, 20, 40 and 50 cells, respectively (\nameref{S5_Fig}B).
...
other, i.e., an organism can change between different GRNs without losing its
...
regulatory networks or to identify new ones in nature.
