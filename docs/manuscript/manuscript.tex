...
of the regulatory systems through genetic modifications in order to meet specific functional requirements under selective pressures.

 which allows to fine-tune the regulatory system according to its specific
